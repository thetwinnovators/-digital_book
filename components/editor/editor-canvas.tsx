...
import type { Spread, BrochureElement } from "@/lib/types"
    ...
    <div ref={containerRef} className="flex-1 flex items-center justify-center overflow-hidden">
      <div
        style={{
          ...
          marginLeft: `${((containerRef.current?.getBoundingClientRect().width ?? CANVAS_WIDTH * scale) - CANVAS_WIDTH * scale) / 2}px`,
          marginTop: `${((containerRef.current?.getBoundingClientRect().height ?? CANVAS_HEIGHT * scale) - CANVAS_HEIGHT * scale) / 2}px`,
        }}
